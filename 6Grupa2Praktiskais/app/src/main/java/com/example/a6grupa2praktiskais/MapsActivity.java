package com.example.a6grupa2praktiskais;
...
import com.example.a6grupa2praktiskais.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    task.addOnSuccessListener(new OnSuccessListener<Location>() {
      @Override
      public void onSuccess(@NonNull @org.jetbrains.annotations.NotNul Location location;
        location){
            if (location != null) {
    ...
    @Override
    public void onRequestPermissionsResult(int requestCode, @NonNull @NotNull String[] permission) {
        switch (REQUEST_CODE) {
            case REQUEST_CODE:
